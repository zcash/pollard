...
pub trait EccInstructions<C: CurveAffine>: Chip<Field = C::Base> {
    ...
    /// Variable representing an element of the elliptic curve's scalar field, to be used for fixed-base scalar mul.
...
/// An element of the given elliptic curve's scalar field, to be used for fixed-base scalar mul.
#[derive(Debug)]
